...
const Acceuil = () => {
    ...
    const LogementsFiltres = logementsFictifs.filter(l => {
  ...
  style={{
    ...
    backgroundPosition: 'center',
     ...
     <div className=" py-16 px-4 text-center ">
        <h1 className="text-4xl font-bold mb-4 text-black">Trouvez un logement rapidement au Cameroun</h1>
        <p className="text-lg mb-8 text-black">Chambre, Maison, studios disponible près de vous</p>
         </div>
        ...
        />
        <button className="bg-yellow-400 text-gray-800 font-bold px-6 rounded-r-lg hover:bg-yellow-500 ">Rechercher</button>
     </div>
